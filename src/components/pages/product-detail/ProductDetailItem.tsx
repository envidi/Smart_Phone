...
function ProductDetailItem({data}:any) {
    ...
    const handleIncrease = () =>{
       ...
       const handleAddToCart = ()=>{
        const {id , category_id , ...other} = data
        dispatch(cartAction.increase({
          ...other, id : Math.floor(Math.random() * 10000), id_product : id, quantity : quantityProduct,id_cate: data.category_id
      ...
      <div className="col-md-6-detail _boxzoom">
          ...
          <div className="_product-images">
            <div className="picZoomer h-[400px]">
                <img className="my_img" src={data?.image} alt=""/>
            </div>
          </div>
      </div>
      <div className="col-md-6">
          <div className="_product-detail-content">
            <p className="_p-name "> {data?.name} </p>
            ...
            <div className="_p-price-box mt-3 ">
                <div className="p-list">
                  ...
                  <span className="price"> {formatter.format(data?.price)} </span>
                </div>
